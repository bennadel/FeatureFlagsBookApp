					...
					<tr>
						...
						<cfloop array="#features#" item="feature">
							...
							<td
								...
								<a
									href="/index.cfm?event=playground.staging.explain&userID=#encodeForUrl( demoUser.id )#&featureKey=#encodeForUrl( feature.key )#&environmentKey=#encodeForUrl( url.environmentKey )#&from=staging"
									class="explain">
